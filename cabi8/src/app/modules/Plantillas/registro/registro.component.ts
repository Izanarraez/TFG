...
export class RegistroComponent{
    ...
    currentUsuario: Usuario = { id: 0, nombre: this.nombre, correo: this.correo, tipo_usuario: 1, contraseña:this.contrase, foto: this.foto};
    ...
    createUsuario(): void {
      this.RegistroService.createUsuario(this.currentUsuario)
        .subscribe(us => {
          ...
          this.currentUsuario = { id: 0, nombre:  this.nombre, correo: this.correo, tipo_usuario: 1, contraseña:this.contrase, foto: this.foto};
        });
    }
}
